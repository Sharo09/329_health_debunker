...
import { GeneralisationWarning } from "../results/GeneralisationWarning";
import { StratifiedEvidence } from "../results/StratifiedEvidence";
    ...
    <div className="animate-fade-in max-w-4xl space-y-6">
      ...
      {verdict && (
        <>
          ...
          {/* Patch B — generalisation warnings and stratified evidence
              live between the verdict and the stance tabs so the user
              sees caveats before diving into individual papers. */}
          <GeneralisationWarning warnings={verdict.generalisation_warnings} />
          <StratifiedEvidence
            buckets={verdict.stratum_buckets}
            stratifications={verdict.paper_stratifications}
          />
